...
In this project, I: - Created a GitHub repository to understand how version control works. - I used GitHub Codespaces to edit and write the HTML code for the webpage. - Explored basic HTML and CSS to style the webpage. - Published the webpage using GitHub Pages to understand web hosting. 
...
## View the Webpage You can view the webpage I created at `https://duesams.github.io/helloworld/`.
